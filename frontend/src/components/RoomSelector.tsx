    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-start p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Select a Room</h2>
          ...
          <div className="mb-6">
            ...
            {availableRooms.length === 0 ? (
              <div className="p-4 text-center text-gray-500 bg-gray-50 rounded-lg border border-gray-200">
                <p className="text-sm">No available rooms for this time slot</p>
              </div>
            ) : (
        ...
        <div className="border-t border-gray-200 p-6 bg-gray-50 flex gap-3">
          ...
          >
            {isLoading ? "Scheduling..." : "Schedule Course"}
          </button>
        </div>
      </div>
    </div>
